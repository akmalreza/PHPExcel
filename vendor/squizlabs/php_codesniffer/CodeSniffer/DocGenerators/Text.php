...
if (!class_exists('PHP_CodeSniffer_DocGenerators_Generator', true)) {
...
class PHP_CodeSniffer_DocGenerators_Text extends PHP_CodeSniffer_DocGenerators_Generator
{
    ...
    protected function printCodeComparisonBlock($node)
    {
        ...
        for ($i = 0; $i < $maxTitleLines; $i++) {
            $firstLineText = isset($firstTitleLines[$i]) ? $firstTitleLines[$i] : '';

            $secondLineText = isset($secondTitleLines[$i]) ? $secondTitleLines[$i] : '';
        ...
        for ($i = 0; $i < $maxCodeLines; $i++) {
            $firstLineText = isset($firstLines[$i]) ? $firstLines[$i] : '';

            $secondLineText = isset($secondLines[$i]) ? $secondLines[$i] : '';
