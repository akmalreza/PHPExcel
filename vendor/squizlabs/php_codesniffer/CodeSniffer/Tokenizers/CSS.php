        ...
        for ($stackPtr = 0; $stackPtr < $numTokens; $stackPtr++) {
            ...
            case T_COLON:
                ...
                for ($x = ($stackPtr - 1); $x >= 0; $x--) {
                    if (!isset(PHP_CodeSniffer_Tokens::$emptyTokens[$finalTokens[$x]['code']])) {
                        break;
                    }
                }
            ...
            case T_STRING:
                if (strtolower($token['content']) === 'url') {
                    ...
                    for ($y = ($x + 1); $y < $numTokens; $y++) {
                        if (!isset(PHP_CodeSniffer_Tokens::$emptyTokens[$finalTokens[$y]['code']])) {
                            break;
                        }
                    }
                    ...
                    if (isset($finalTokens[($stackPtr - 1)])
                        && $finalTokens[($stackPtr - 1)]['code'] === T_STRING
                    ) {
