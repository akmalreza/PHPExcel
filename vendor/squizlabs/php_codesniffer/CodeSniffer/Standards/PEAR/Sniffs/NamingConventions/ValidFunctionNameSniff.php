...
class PEAR_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
     ...
     */
    protected array $magicMethods = array(
                               'construct'  => true,
                               'destruct'   => true,
                               'call'       => true,
                               'callstatic' => true,
     ...
     */
    protected array $magicFunctions = array('autoload' => true);
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $isPublic = $methodProps['scope'] !== 'private';
        ...
        if ($isPublic && $scopeSpecified === true && $methodName[0] === '_') {
        ...
        if (!PHP_CodeSniffer::isCamelCaps($testMethodName, false, $isPublic, false)) {
    ...
    protected function processTokenOutsideScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (!PHP_CodeSniffer::isCamelCaps($camelCapsPart, false, true, false)) {
            $validName        = false;
        ...
        if (!$validName) {
            ...
            $newName = $newPackagePart === '' ? $newCamelCapsPart : rtrim($newPackagePart, '_').'_'.$newCamelCapsPart;
