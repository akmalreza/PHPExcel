        ...
        for ($i = ($openBracket + 1); $i <= $closeBracket; $i++) {
            ...
            if ($tokens[$i]['line'] !== $prevLine) {
                if ($tokens[$i]['line'] === $tokens[$closeBracket]['line']) {
                    ...
                    $expectedIndent = $next !== $closeBracket ? $statementIndent + $this->indent : $statementIndent;//end if
                } else {
                ...
                if ($next !== $closeBracket && !isset(PHP_CodeSniffer_Tokens::$booleanOperators[$tokens[$next]['code']])) {
