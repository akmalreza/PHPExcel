    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($content !== '/*' && $content !== '/**') {
            ...
            if ($fix) {
                ...
                if ($tokens[($stackPtr - 1)]['code'] === T_WHITESPACE) {
                    if (isset($tokens[($stackPtr - 1)]['orig_content'])) {
        ...
        if (trim($tokens[$commentLines[1]]['content']) === '') {
            ...
            if ($leadingSpace !== $starColumn) {
                ...
                if ($fix) {
                    if (isset($tokens[$commentLines[1]]['orig_content'])
        ...
        foreach ($commentLines as $line) {
            ...
            if ($leadingSpace < $starColumn) {
                ...
                if ($fix) {
                    if (isset($tokens[$line]['orig_content'])
        ...
        if (isset($tokens[$contentBefore]['scope_closer'])
