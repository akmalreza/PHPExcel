...
class Squiz_Sniffs_Commenting_LongConditionClosingCommentSniff implements PHP_CodeSniffer_Sniff
{
     ...
     * @var array(int)
     */
    private static array $_openers = array(
                                T_SWITCH,
                                T_IF,
                                T_FOR,
                                T_FOREACH,
     ...
     */
    public string $commentFormat = '//end %s';
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (!in_array($startCondition['code'], self::$_openers)) {
            return;
        }
        ...
        if ($startCondition['code'] === T_IF) {
            ...
            do {
                ...
                if ($tokens[$nextToken]['code'] === T_ELSE || $tokens[$nextToken]['code'] === T_ELSEIF) {
                    ...
                    if ($tokens[$nextToken]['code'] === T_ELSE
                        && !isset($tokens[$nextToken]['scope_closer'])
                    ) {
                    ...
                    if (!isset($tokens[$nextToken]['scope_closer'])) {
            ...
            } while (isset($tokens[$nextToken]['scope_closer']));
        }//end if
