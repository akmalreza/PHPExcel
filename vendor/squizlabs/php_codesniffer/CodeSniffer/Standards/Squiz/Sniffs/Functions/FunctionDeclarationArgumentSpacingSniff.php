...
class Squiz_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function processBracket(PHP_CodeSniffer_File $phpcsFile, $openBracket)
    {
        ...
        while (($nextParam = $phpcsFile->findNext(T_VARIABLE, ($nextParam + 1), $closeBracket)) !== false) {
            ...
            $whitespace = $phpcsFile->isReference($checkToken) ? $checkToken - 1 : $checkToken;
            ...
            if (!empty($params)) {
                ...
                if ($phpcsFile->isReference($nextToken)) {
                    $nextToken++;
                }
                ...
                if ($tokens[$nextToken]['code'] !== T_ELLIPSIS && $nextToken !== $nextParam) {
                    ...
                    if (!$multiLine && $spaceAfterOpen !== $this->requiredSpacesAfterOpen) {
                ...
                } elseif (!$multiLine && $gap !== $this->requiredSpacesAfterOpen) {
        ...
        } elseif (!$multiLine && $gap !== $this->requiredSpacesBeforeClose) {
