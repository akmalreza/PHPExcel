...
class Generic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
     ...
     */
    protected array $methodsDoubleUnderscore = array(
                                          'soapcall'               => true,
                                          'getlastrequest'         => true,
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (!PHP_CodeSniffer::isCamelCaps($methodName, false, true, $this->strict)) {
    ...
    protected function processTokenOutsideScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (!PHP_CodeSniffer::isCamelCaps($functionName, false, true, $this->strict)) {
