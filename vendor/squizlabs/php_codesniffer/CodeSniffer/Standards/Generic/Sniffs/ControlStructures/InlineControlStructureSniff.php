...
class Generic_Sniffs_ControlStructures_InlineControlStructureSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $closer = isset($tokens[$stackPtr]['parenthesis_closer']) ? $tokens[$stackPtr]['parenthesis_closer'] : $stackPtr;
        ...
        for ($end = ($closer + 1); $end < $phpcsFile->numTokens; $end++) {
            ...
            if (in_array($tokens[$end]['code'], $fixableScopeOpeners)
                && !isset($tokens[$end]['scope_opener'])
            ) {
            ...
            if (isset($tokens[$end]['scope_opener'])) {
            ...
            if (isset($tokens[$end]['parenthesis_closer'])) {
