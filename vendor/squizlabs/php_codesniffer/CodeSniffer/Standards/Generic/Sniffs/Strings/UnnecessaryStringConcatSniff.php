...
class Generic_Sniffs_Strings_UnnecessaryStringConcatSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        } elseif ($phpcsFile->tokenizerType === 'PHP') {
            return;
        }
        ...
        if (isset(PHP_CodeSniffer_Tokens::$stringTokens[$tokens[$prev]['code']])
            && isset(PHP_CodeSniffer_Tokens::$stringTokens[$tokens[$next]['code']])
        ) {
