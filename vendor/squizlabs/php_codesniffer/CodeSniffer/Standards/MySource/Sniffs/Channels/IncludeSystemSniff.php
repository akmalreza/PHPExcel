...
class MySource_Sniffs_Channels_IncludeSystemSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(
        ...
        if (isset($this->_ignore[strtolower($className)])) {
            return;
        }
        ...
        $condPtr = $currScope;
        if ($phpcsFile->hasCondition($stackPtr, T_CLASS)) {
        ...
        if (!isset($includedClasses[strtolower($className)])) {
    ...
    protected function getIncludedClassFromToken(
        ...
        } elseif (isset(PHP_CodeSniffer_Tokens::$includeTokens[$tokens[$stackPtr]['code']])) {
