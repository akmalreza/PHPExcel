...
final class PHP_CodeSniffer_Tokens
{
     ...
     * @var array(int => int)
     */
    public static array $weightings = array(
                                 T_CLASS               => 1000,
                                 T_INTERFACE           => 1000,
                                 T_TRAIT               => 1000,
                                 T_NAMESPACE           => 1000,
     ...
     * @var array(int => int)
     */
    public static array $knownLengths = array(
                                   T_ABSTRACT                 => 8,
                                   T_AND_EQUAL                => 2,
                                   T_ARRAY                    => 5,
                                   T_AS                       => 2,
     ...
     * @var array(int)
     */
    public static array $assignmentTokens = array(
                                       T_EQUAL          => T_EQUAL,
     ...
     * @var array(int)
     */
    public static array $equalityTokens = array(
     ...
     * @var array(int)
     */
    public static array $comparisonTokens = array(
                                       T_IS_EQUAL            => T_IS_EQUAL,
                                       T_IS_IDENTICAL        => T_IS_IDENTICAL,
                                       T_IS_NOT_EQUAL        => T_IS_NOT_EQUAL,
                                       T_IS_NOT_IDENTICAL    => T_IS_NOT_IDENTICAL,
     ...
     * @var array(int)
     */
    public static array $arithmeticTokens = array(
                                       T_PLUS     => T_PLUS,
                                       T_MINUS    => T_MINUS,
     ...
     * @var array(int)
     */
    public static array $castTokens = array(
     ...
     * @var array(int)
     */
    public static array $parenthesisOpeners = array(
                                         T_ARRAY    => T_ARRAY,
     ...
     * @var array(int)
     */
    public static array $scopeOpeners = array(
                                   T_CLASS      => T_CLASS,
     ...
     * @var array(int)
     */
    public static array $scopeModifiers = array(
                                     T_PRIVATE   => T_PRIVATE,
                                     T_PUBLIC    => T_PUBLIC,
     ...
     * @var array(int)
     */
    public static array $methodPrefixes = array(
                                     T_PRIVATE   => T_PRIVATE,
                                     T_PUBLIC    => T_PUBLIC,
                                     T_PROTECTED => T_PROTECTED,
     ...
     * @var array(int)
     */
    public static array $operators = array(
                                T_MINUS       => T_MINUS,
                                T_PLUS        => T_PLUS,
                                T_MULTIPLY    => T_MULTIPLY,
                                T_DIVIDE      => T_DIVIDE,
     ...
     * @var array(int)
     */
    public static array $booleanOperators = array(
     ...
     * @var array(int)
     */
    public static array $blockOpeners = array(
     ...
     * @var array(int)
     */
    public static array $emptyTokens = array(
     ...
     * @var array(int)
     */
    public static array $commentTokens = array(
                                    T_COMMENT                => T_COMMENT,
                                    T_DOC_COMMENT            => T_DOC_COMMENT,
                                    T_DOC_COMMENT_STAR       => T_DOC_COMMENT_STAR,
                                    T_DOC_COMMENT_WHITESPACE => T_DOC_COMMENT_WHITESPACE,
     ...
     * @var array(int)
     */
    public static array $stringTokens = array(
     ...
     * @var array(int)
     */
    public static array $textStringTokens = array(
                                       T_CONSTANT_ENCAPSED_STRING => T_CONSTANT_ENCAPSED_STRING,
                                       T_DOUBLE_QUOTED_STRING     => T_DOUBLE_QUOTED_STRING,
     ...
     * @var array(int)
     */
    public static array $bracketTokens = array(
                                    T_OPEN_CURLY_BRACKET   => T_OPEN_CURLY_BRACKET,
     ...
     * @var array(int)
     */
    public static array $includeTokens = array(
     ...
     * @var array(int)
     */
    public static array $heredocTokens = array(
     ...
     * @var array(int)
     */
    public static array $functionNameTokens = array(
                                         T_STRING       => T_STRING,
                                         T_EVAL         => T_EVAL,
                                         T_EXIT         => T_EXIT,
                                         T_INCLUDE      => T_INCLUDE,
    ...
    public static function getHighestWeightedToken(array $tokens)
    {
        ...
        foreach ($tokens as $token) {
            $weight = isset($weights[$token]) ? $weights[$token] : 0;
