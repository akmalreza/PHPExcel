    ...
    private static function getAttribute($component, $name, $format)
    {
        ...
        if (isset($attributes[$name])) {
            if ($format == 'string') {
                ...
                return !(boolean) ($attributes[$name] === '0' || $attributes[$name] !== 'true');
            } else {
...
//            echo $detailKey, ' => ',self::getAttribute($detail, 'val', 'string'),PHP_EOL;
    ...
    private static function parseRichText($titleDetailPart = null)
    {
        ...
        foreach ($titleDetailPart as $titleDetailElementKey => $titleDetailElement) {
            if (property_exists($titleDetailElement, 't') && $titleDetailElement->t !== null) {
                $objText = $value->createTextRun((string) $titleDetailElement->t);
            }
            if (property_exists($titleDetailElement, 'rPr') && $titleDetailElement->rPr !== null) {
