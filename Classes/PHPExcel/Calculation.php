...
{
    /**
     * @var \PHPExcel_CalcEngine_Logger|mixed
     */
    public $_debugLog;
    /** Constants                */
    /** Regular Expressions        */
     ...
     */
    private static array $workbookSets;
     ...
     * @access    private
     */
    private array $calculationCache = array ();
     ...
     *
     */
    private \PHPExcel_CalcEngine_Logger $debugLog;
     ...
     *
     */
    public static array $localeBoolean = array(
        'TRUE'  => 'TRUE',
        'FALSE' => 'FALSE',
        'NULL'  => 'NULL'
    );
    ...
    private static array $excelConstants = array(
     ...
     //    PHPExcel functions
    private static array $PHPExcelFunctions = array(
        'ABS' => array(
    ...
    {
        if (!$pCell instanceof \PHPExcel_Cell) {
            return null;
        }
    ...
    public function calculateFormula($formula, $cellID = null, PHPExcel_Cell $pCell = null)
    {
        ...
        if ($this->workbook !== null && $cellID === null && !$pCell instanceof \PHPExcel_Cell) {
            $cellID = 'A1';
        ...
        if ($this->_debugLog->getWriteDebugLog()) {
            ...
            if (is_array($value)) {
                ...
                foreach ($value as $row) {
                    if (is_array($row)) {
                        $returnMatrix[] = implode($pad, array_map(function ($value) {
...
//                            echo '$cellRef='.$cellRef.' in current worksheet<br />';
                ...
                } elseif (!$pCell instanceof \PHPExcel_Cell) {
